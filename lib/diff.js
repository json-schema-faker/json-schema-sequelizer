...
function buildSchema(reference, models, schema, source, prev, raw, op) {
  ...
  const tableName = modelOptions.underscored && !modelOptions.freezeTableName
    ? util.normalizeProp(null, models[reference].tableName, true)
    : models[reference].tableName;
