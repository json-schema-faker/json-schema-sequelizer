            ...
            if (item[ref.model]) {
              ...
              tasks.push(row => {
                ...
                if (hasKeys) {
                  ...
                  Object.keys(models[modelName].primaryKeys).forEach(pk => {
                    rel[modelName + pk[0].toUpperCase() + pk.substr(1)] = inputData[pk];
                  });

                  Object.keys(models[ref.model].primaryKeys).forEach(pk => {
                    rel[ref.model + pk[0].toUpperCase() + pk.substr(1)] = inputData[pk] || null;
                  });
