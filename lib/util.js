      ...
      if (models[b.target].model.virtual !== true) {
        ...
        if (b.params.through) {
          ...
          if (!(models[through.model] || defns[through.model])
            ...
            makeFK(defns[through.model].$schema.properties, a.model, b.method);
            makeFK(defns[through.model].$schema.properties, models[b.target].model, b.method);
          }

          conn.models[through.model].options._hasForeignKeys = 2;
        }
