...
function makeModel(ref, conn, defns, schemas) {
  ...
  if (schema.virtual === true) {
    ...
    _model = conn.models[ref] || conn.define(ref, _types.props, Object.assign(model, schema.options));
  ...
  // overrides
  Object.assign(_model.prototype, model.instanceMethods);
  Object.assign(_model, model.classMethods);
